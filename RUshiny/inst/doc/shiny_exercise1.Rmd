...
* Put the table and plots in separate cards and make the card that has the table collapseable.
...
server_ex2 <- function(input, output){
...
server_ex3 <- function(input, output){
